...
The main function in the package is `query_cdec()`. 

```r 
# download data from kwk, sensor 20, duration is event type (every 15 minutes)
kwk_flow <- cdec_query("KWK", "20", "E", "2000-01-01", "2002-01-01")
```

The resulting dataframe is of tidy form.
