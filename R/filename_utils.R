...
#' @param filename filename that complies to CDEC folder naming scheme
...
#' Given a directory that complies to the CDEC naming convention
#' this function will build a data.frame log of database data
build_data_log <- function(data_dir) {
