...
Although CDEC provides a good data service its interface lacks in user interface.
...
[here](#), as well as open any issues regarding bugs, or features you want to see
in future version.

You can learn more as well see fully implemented examples using CDECRetrieve [here]()
